...
/**
 * SQLite implementation of PermbanRepository.
 * Uses SQLite-specific SQL syntax.
 */
public class SQLitePermbanRepository implements PermbanRepository
{
    private final TotalFreedomMod plugin;
    private final StatementHandler statementHandler;

    public SQLitePermbanRepository(TotalFreedomMod plugin, StatementHandler statementHandler)
    {
        this.plugin = plugin;
    ...
    public void insertIps(int permbanId, List<String> ips) throws SQLException
    {
        ...
        String sql = "INSERT OR IGNORE INTO permban_ips (permban_id, ip) VALUES (?, ?)";
        for (String ip : ips)
        {
    ...
    {
        // First get the permban IDs for the given IP
