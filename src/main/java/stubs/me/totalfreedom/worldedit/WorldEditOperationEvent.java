...
// TF-WorldEdit is a WorldEdit extension that adds WorldEditOperationEvent
// This event fires before WorldEdit operations (//set, //replace, //fill, etc.) execute
// Requires: WorldEdit 7.3.x + TF-WorldEdit extension plugin installed
public class WorldEditOperationEvent extends Event
{
